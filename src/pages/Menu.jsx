...
const Menu = () => {
  ...
  const mockMenuItems = [
    ...
    { id: 9, name: 'Turkey Club', description: 'Roasted turkey with bacon and avocado', price: 11.00, category: 'Sandwiches', tags: [], image: 'https://images.unsplash.com/photo-1553909489-cf46db38dfb9?w=400&h=300&fit=crop' },
